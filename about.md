...
- 제품을 더 읽기 좋고 쓰기 좋게 만드는 디자인 메모
- 개발하면서 반복적으로 만나는 문제와 해결 방식

## 어떤 기준으로 운영하나요

- 짧더라도 실제 도움이 되는 글을 씁니다.
- 코드만 설명하지 않고 왜 그렇게 설계했는지도 적습니다.
- 나중에 다시 읽어도 바로 이해되는 구조를 우선합니다.
